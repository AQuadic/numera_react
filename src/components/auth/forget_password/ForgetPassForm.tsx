...
const ForgetPassForm = () => {
    ...
    return (
        ...
        <h2 className="text-[#192540] text-[40px] font-medium text-center">Forget Password</h2>
        <p className="text-[#717171] text-base font-medium mt-3 leading-[150%] text-center">
            Enter your email and we’ll help you recover your account in just a  <br />few steps.
        </p>
        ...
        <form className="mt-6">
            ...
            <p className="text-[#192540] text-base font-medium mt-4 text-center">Don’t receive code?</p>

            <p className="text-[#717171] text-sm font-medium mt-2 text-center">You may request a new code in <span className="text-[#192540]">1:00</span> </p>
