        ...
        <section>
            ...
            <div className="w-full py-4 px-6 bg-[#EBAF29] rounded-md mt-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Crown />
                    <div>
                        <h2 className="text-[#192540] text-base font-medium leading-[100%]">Gold Plan</h2>
                        <p className="text-[#4A4848] text-sm font-normal leading-[100%] mt-2">Active until Dec 15, 2024</p>
                    </div>
                </div>
            ...
            <div className="mt-8 flex flex-col gap-6">
                <Accordion type="single" collapsible>
                    <AccordionItem value="item-1" className="border border-[#F0F0F0] rounded-md px-6">
                        <AccordionTrigger>
                            <div className="flex items-center gap-2">
                                <Profile />
                                <p className="text-[#192540] text-base font-medium">Personal Information </p>
                            </div>
                        </AccordionTrigger>
                        <AccordionContent>
                            <div className="px-2">
                                <label htmlFor="name" className="text-[#192540] text-base">Name</label>
                                <input 
                                    type="text"
                            ...
                            <div className="px-2 mt-4">
                                <label htmlFor="password" className="text-[#192540] text-base">Password</label>
                                <input 
                                    type="password"
                                    className="w-full h-12 border rounded-md mt-2 px-2"
                ...
                <Accordion type="single" collapsible>
                    <AccordionItem value="item-2" className="border border-[#F0F0F0] rounded-md px-6">
                        <AccordionTrigger>
                            <div className="flex items-center gap-2">
                                <Change_password />
                                <p className="text-[#192540] text-base font-medium">Change Password</p>
                            </div>
                        </AccordionTrigger>
                        <AccordionContent>
                            <div className="px-2">
                            ...
                            <div className="px-2 mt-4">
                                <label htmlFor="new_password" className="text-[#192540] text-base">New Password</label>
                                <input 
                                    type="password"
                                    className="w-full h-12 border rounded-md mt-2 px-2"
                                    placeholder="Enter your password"
            ...
            <div className="mt-6 border border-[#F0F0F0] rounded-md px-6 py-3.5 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <Verified />
                    <p className="text-[#192540] text-base font-medium">Account Verification</p>
                </div>
