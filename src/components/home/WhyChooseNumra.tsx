...
const WhyChooseNumra = () => {
    return (
        <section className="container md:py-[58px] py-10">
            <h2 className="text-[#192540] text-[32px] font-medium">Why Choose <span className="text-[#B48110]">Numra</span></h2>
            ...
            <div className="md:mt-20 mt-5 flex flex-wrap items-center justify-between gap-8">
                <div className="relative">
                    ...
                    <h2 className="text-[#192540] text-2xl font-semibold mt-1">Ease of use at every step</h2>
                ...
                <div className="relative">
                    ...
                    <h2 className="text-[#192540] text-2xl font-semibold mt-1">We're here whenever you need us</h2>
                ...
                <div className="relative">
                    ...
                    <h2 className="text-[#192540] text-2xl font-semibold mt-1">Your privacy is our responsibility</h2>
